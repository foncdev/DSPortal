...
export function getDocumentsByTag(tag) {
    return mockDocuments.filter(doc => doc.tags?.some(docTag => docTag.toLowerCase() === tag.toLowerCase()));
}
/**
 * 문서를 생성합니다.
...
export function searchDocuments(query) {
    ...
    return mockDocuments.filter(doc => doc.title.toLowerCase().includes(lowercaseQuery) ||
